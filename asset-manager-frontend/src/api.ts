...
export const createAsset = (data: { name: string; category?: string; quantity?: number }) =>
    axios.post(`${API_URL}/assets`, data);
export const updateAsset = (id: number, data: { name?: string; category?: string; quantity?: number }) =>
